...
public class Checkout {
    ...
    private void populateDataTable() throws Exception{
        ...
        TableColumn n_apar = new TableColumn("NAPAR"); 
        ...
        System.out.println(date_checkout.getValue().format(DateTimeFormatter.ofPattern("MM-dd-yyyy")));
        String json = conn.getMethod("checkin/"+date_checkout.getValue().format(DateTimeFormatter.ofPattern("MM-dd-yyyy")));
